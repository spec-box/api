...
public static class BulkWriterExtensions
{
    ...
    public static BulkWriterFeatureDependency CreateFeatureDependencyWriter(this NpgsqlConnection connection)
    {
        return new BulkWriterFeatureDependency(connection);
    }
}
